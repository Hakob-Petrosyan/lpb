...
{if $modx->config['lg_theme_bg_color']}--color_three:{$modx->config['lg_theme_bg_color']};{else}--color_three:#283593;{/if}   
 --font_one:{if $modx->config['lg_theme_font']==1}Gilroy{/if}{if $modx->config['lg_theme_font']==2}"Open Sans"{/if}{if $modx->config['lg_theme_font']==3}"Roboto"{/if}{if $modx->config['lg_theme_font']==4}"Circe"{/if}{if $modx->config['lg_theme_font']==5}"GothamPro"{/if};
}
</style>
...
{/if}
{if $modx->config['lg_theme_font']==4}
<link rel="stylesheet" type="text/css" href="{$_config.manager_url}templates/light_theme/css/circe.css" />
{/if}
