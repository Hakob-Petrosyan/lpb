...
class pageBlockGetProcessor extends modObjectGetProcessor
{
    ...
    public function cleanup()
    {
        ...
        // Получаем чанк
        if ($this->properties['chunk'] && $chunk = $this->modx->getObject('modChunk', ['name' => $array['chunk']])) {
            $array['chunk_id'] = $chunk->id;
