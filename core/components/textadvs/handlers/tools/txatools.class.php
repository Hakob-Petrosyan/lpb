...
class txaTools
{
    ...
    public function runProcessor($action = '', $data = array())
    {
        ...
        $processorsPath = !empty($this->txa->config['processorsPath']) ? $this->txa->config['processorsPath'] : MODX_CORE_PATH;

        /* @var modProcessorResponse $response */
        $response = $this->modx->runProcessor($action, $data, array('processors_path' => $processorsPath));

        return $this->txa->config['prepareResponse'] ? $this->prepareResponse($response) : $response;
    }
    ...
    public function prepareResponse($response)
    {
        ...
        if ($this->txa->config['jsonResponse'] AND is_array($output)) {
            $output = $this->modx->toJSON($output);
        } elseif (!$this->txa->config['jsonResponse'] AND !is_array($output)) {
    ...
    {
        if ($pdoTools = $this->txa->getPdoTools()) {
    ...
    public function success($message = '', $data = array(), $placeholders = array())
    {
        ...
        return $this->txa->config['jsonResponse'] ? $this->modx->toJSON($response) : $response;
    }
