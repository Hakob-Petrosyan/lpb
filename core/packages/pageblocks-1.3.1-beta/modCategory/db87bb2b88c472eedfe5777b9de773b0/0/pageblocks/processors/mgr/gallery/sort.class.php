...
class PageBlocksFileSortProcessor extends modObjectProcessor
{
...
//    public $permission = 'pageblocksfile_save';
    ...
    /**
     * @param blockFile $source
     * @param blockFile $target
     *
     * @return array|string
     */
    public function sort(blockFile $source, blockFile $target)
    {
...
return 'PageBlocksFileSortProcessor';