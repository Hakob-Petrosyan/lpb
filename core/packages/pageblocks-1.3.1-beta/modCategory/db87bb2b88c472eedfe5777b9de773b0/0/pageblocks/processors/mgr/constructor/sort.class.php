...
class blockConstructorSortProcessor extends modObjectProcessor
{
    ...
    public function process()
    {
        ...
        foreach ($sources as $id) {
            /** @var blockConstructor $source */
            $source = $this->modx->getObject($this->classKey, compact('id'));
            /** @var blockConstructor $target */
    ...
    /**
     * @param blockConstructor $source
     * @param blockConstructor $target
     *
     * @return array|string
     */
    public function sort(blockConstructor $source, blockConstructor $target)
    {
...
return 'blockConstructorSortProcessor';