...
class blockTableSortProcessor extends modObjectProcessor
{
    ...
    /**
     * @param blockTable $source
     * @param blockTable $target
     *
     * @return array|string
     */
    public function sort(blockTable $source, blockTable $target)
    {
...
return 'blockTableSortProcessor';