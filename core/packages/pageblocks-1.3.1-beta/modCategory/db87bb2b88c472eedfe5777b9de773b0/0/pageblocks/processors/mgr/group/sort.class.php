...
class blockFieldGroupSortProcessor extends modObjectProcessor
{
    ...
    public function process()
    {
        ...
        foreach ($sources as $id) {
            /** @var blockFieldGroup $source */
            $source = $this->modx->getObject($this->classKey, compact('id'));
            /** @var blockFieldGroup $target */
    ...
    /**
     * @param blockFieldGroup $source
     * @param blockFieldGroup $target
     *
     * @return array|string
     */
    public function sort(blockFieldGroup $source, blockFieldGroup $target)
    {
...
return 'blockFieldGroupSortProcessor';