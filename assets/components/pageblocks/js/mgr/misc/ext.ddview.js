PageBlocks.DragZone = function (view) {
    this.view = view;
    PageBlocks.DragZone.superclass.constructor.call(this, view.getEl());
};
Ext.extend(PageBlocks.DragZone, Ext.dd.DragZone, {
...
PageBlocks.DropZone = function (view) {
    this.view = view;
    PageBlocks.DropZone.superclass.constructor.call(this, view.getEl(), {containerScroll: true});
};
Ext.extend(PageBlocks.DropZone, Ext.dd.DropZone, {
